import CardComponentFeatures from "../CardComponentFeatures";
    ...
    return(
        ...
        <div className='section-features-container' >
            {/* <div className='section-features-card'>
              ...
              <h className="center-text">Satisfied Customers</h>
              <span className="center-text">1963</span>
            </div> */}
            <CardComponentFeatures
